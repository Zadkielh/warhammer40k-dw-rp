local PANEL = {}
	...
	local dwlogo = nut.util.getMaterial("vgui/dw_logo.png")
	local fourklogo = nut.util.getMaterial("vgui/warhammer_40k_logo.png")
		...
		self.background:SetHTML([[
			<html>
				<body style="margin: 0; padding: 0; overflow: hidden;">
					<img src="https://i.imgur.com/GNqKE0o.gif" width="1920" height="1080" />
				</body>
			</html>
		]])
		--https://media.giphy.com/media/13f7nHY1g0ehVu/giphy.gif JOJO   AAAAAAAAAAAAA https://i.imgur.com/GNqKE0o.gif
	...
	self.delta = math.Approach(self.delta, 255, FrameTime() * 200)
		surface.SetDrawColor(0, 0, 0, 235)
		surface.SetTexture(gradient)
		surface.DrawTexturedRect(0, 0, w, h)
		if (self.logo) then
		
		surface.SetDrawColor(255, 255, 255, self.delta)
		surface.SetMaterial( dwlogo )
		surface.DrawTexturedRect(200, 90, 208, 340)
		
		surface.SetDrawColor(255, 255, 255, self.delta)
		surface.SetMaterial( fourklogo )
		surface.DrawTexturedRect(550, 0, 800, 157)
		end
	end
